...
a) config mep mepid <mepid val> md name <md name> level <md level> ma <ma name> assoc-id <association id interval <ccm interval>
...
c) config mep intf <mep interface> interval <milliseconds>
